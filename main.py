...
# commands 
command_list = ['!help', '!set_money', '!my_purchases', '!my_transactions']
...
while True:
    ...
    print("###########")
    print("Current command : !help !set_money !my_purchases, !my_transactions,")
